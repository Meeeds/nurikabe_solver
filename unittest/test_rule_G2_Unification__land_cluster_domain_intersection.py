...
TEST_DATA_FILES = [
    'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_0.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_1.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_2.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_3.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_4.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_5.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_6.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_7.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_8.json', 'unittest/data/rule_G2_Unification__land_cluster_domain_intersection_9.json'
]

...
TEST_DATA_FILES = [
    'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_0.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_1.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_2.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_3.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_4.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_5.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_6.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_7.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_8.json', 'unittest/data/rule_G3_Closure__complete_island_forces_black_neighbors_9.json'
]

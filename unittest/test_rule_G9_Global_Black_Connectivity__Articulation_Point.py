...
TEST_DATA_FILES = [
    'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_0.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_1.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_2.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_3.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_4.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_5.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_6.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_7.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_8.json', 'unittest/data/rule_G9_Global_Black_Connectivity__Articulation_Point_9.json'
]

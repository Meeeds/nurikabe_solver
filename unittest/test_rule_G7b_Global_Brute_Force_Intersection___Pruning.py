...
TEST_DATA_FILES = [
    'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_0.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_1.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_2.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_3.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_4.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_5.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_6.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_7.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_8.json', 'unittest/data/rule_G7b_Global_Brute_Force_Intersection___Pruning_9.json'
]
